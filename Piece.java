...
public abstract class Piece extends JFrame implements Comparable<Piece>{
	...
	public abstract LinkedList<Coordonnee> listeDeplacementsPossibles(LinkedList<Piece> ech, boolean sens);
	public abstract LinkedList<Coordonnee> listEat(LinkedList<Piece> pieces, boolean sens);
